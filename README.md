...
使用 Codex 或其他 AI Agent 参与规划、编码、评审、业务沟通前，先读根目录的 [AGENTS.md](AGENTS.md) 和 [AI_ONTOLOGY.md](AI_ONTOLOGY.md)，再按 [docs/ai-ontology/00_context_manifest.md](docs/ai-ontology/00_context_manifest.md) 选择专题文档。涉及补货、采购单、MCP、租户隔离、数字输出、Skill/Workflow 时，必须同步检查 [docs/ai-ontology/07_guardrails.md](docs/ai-ontology/07_guardrails.md) 和对应 `docs/ai-ontology/cards/*.md`。

本体集成可用下面命令验证：

```bash
pnpm verify:ontology
```
